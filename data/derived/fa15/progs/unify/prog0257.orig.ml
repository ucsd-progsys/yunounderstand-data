...
let rec build (rand, depth) = match rand(0.0,6.0) with
  | 0 -> if (rand(0.0,2.0) = 0.0) then Varx else Vary
  | 1 -> if (depth = 0) then (if (rand(0.0,2.0) = 0.0) then Varx else Vary) else Sine(a)
  | 2 -> if (depth = 0) then (if (rand(0.0,2.0) = 0.0) then Varx else Vary) else Cosine(b)
  | 3 -> if (depth = 0) then (if (rand(0.0,2.0) = 0.0) then Varx else Vary) else Average(c,d)
  | 4 -> if (depth = 0) then (if (rand(0.0,2.0) = 0.0) then Varx else Vary) else Times(e,f)
  | 5 -> if (depth = 0) then (if (rand(0.0,2.0) = 0.0) then Varx else Vary) else Thresh(g,h,i,j)
