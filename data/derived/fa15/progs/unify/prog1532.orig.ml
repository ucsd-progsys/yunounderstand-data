...
let rec assoc (d,k,l) = match l with
  | []   -> d
  | h::t -> match h with
    |(k_i, v_i)  -> if k_i = k then v_i else assoc(d,k,t);;
...
let rec wwhile (f,b) = match f b with
  | (n,flag)  ->  if flag = true then wwhile(f,n) else n;;
...
let fixpoint (f,b) = 
  let func x = let temp = f x in (temp, not (temp = x))
  in wwhile (func,b);;
...
| Mix (ex1, ex2, ex3)           ->   exprToString Average(Times(ex1,ex2),Times(ex2,ex3);;
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
                                                          ...
                                                          let buildMix(e1,e2,e3) = Mix(e1,e2,e3)
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
                                                          let rec eval (e,x,y) = match e with
                                                            ...
                                                            | Mix  (ex1, ex2, ex3) -> (((eval (Times(ex1,ex2),x,y)) +. (eval (Times(ex2,ex3),x,y))) /. 2.0);;
...
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
                                                          ...
                                                          let rec build (rand, depth) = 
                                                            if depth < 1 then 
                                                              let r = rand(0,1) in 
                                                                if r = 0 then buildX() else buildY()
                                                            else
                                                              let r = rand(0,6) in match r with
                                                                ...
                                                                | 5 -> buildSquare(build(rand,depth-1)
                                                                                  | 6 -> buildMix(build(rand,depth-1), build(rand,depth-1), build(rand,depth-1));;
