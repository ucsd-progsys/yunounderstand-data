...
let rec exprToString e = 
  match e with
    ...
    |Divadd(e1,e2,e3) -> "(("^exprToString e1^"+"^exprToString e2^")/"^exprToString e3^")"
...
let buildDivadd                    = Divadd(e1,e2,e3)
...
let rec eval (e,x,y) = 
  match e with
    ...
    |Divadd(e1,e2,e3) -> (eval(e,x,y) +. eval(e,x,y))/.eval(e,x,y)
...
let _ = eval (Sine(Neg(Divadd(VarX,VarY,Vary))),0.8,0.8);;
