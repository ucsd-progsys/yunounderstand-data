...
type expr = 
    ...
    | Times    of expr * expr
    | Diff2    of expr * expr                       (*XXXXXXXXXXXXXX*)
...
let rec exprToString e = match e with
  ...
  | Diff2(e1,e2)        -> "(("^ exprToString e1 ^"-"^ exprToString e2 ^ ")/2)" (*XXXXXXXXXXXXXX*)    
...
let buildDiff2(e1,e2)              = Diff2(e1,e2)                          (*XXXXXXXXXXXXXX*)
...
eval (sampleExprDiff2, -1.,0.5);;                                              (*XXXXXXXXXXXXXX*)
