...
let rec exprToString e = match e with 
  ...
  | Foo (x,y) -> Printf.sprintf "%s<%s?%s*.9:%s*.1" (exprToString x) (exprToString y) (exprToString x) (exprToString x)
  | Clamp (x,y,z) -> Printf.sprintf "clamp(%s,%s,%s)" (exprToString x) (exprToString y) (exprToString z)
;;
