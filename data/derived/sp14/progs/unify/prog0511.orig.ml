...
let rec wwhile (f,b) = 
  let(i, c) = f(b) in
    if(c = true) then wwhile(f, i) else i
(*XXXXXXXXXXXXXXXXXXXXXXXX*)
...
let rec exprToString e = 
  let s = "" in
    match e with
      ...
      | NewB(a, b, c) -> s ^ "(" ^ exprToString(a) ^ "+" ^ exprToString(b) ^ "+" + exprToString(c) ^ ")^0"
...
let rec eval (e,x,y) = 
  match e with 
    ...
    | NewA(a, b) -> sin(pi *. eval(a, x, y)) *. cos(pi *. eval(b, x, y))
    | NewB(a, b, c) -> (eval(a, x, y) +. eval(b, x, y) +. eval(c, x, y)) exp 0
(*XXXXXXXXXXXXXXXXXXXXXXXX*)
...
let g1 () = (10, 0, 5)(*XXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
let g2 () = (11, 0, 5)(*XXXXXXXXXXXXXXXXXXXXXXXXXXXX*)  
let g3 () = (14, 0, 5)(*XXXXXXXXXXXXXXXXXXXXXXXXXXXX*)  

let c1 () = (10, 0, 5)(*XXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
let c2 () = (12, 0, 5)(*XXXXXXXXXXXXXXXXXXXXXXXXXXXX*) 
let c3 () = (13, 0, 5)(*XXXXXXXXXXXXXXXXXXXXXXXXXXXX*) 
