...
let _ = digitsOfInt 23401209
let _ = digitsOfInt 0
let _ = digitsOfInt 111111111
...
let _ = additivePersistence 9492149
let _ = additivePersistence (-192491535)
let _ = additivePersistence 99999998
...
let _ = digitalRoot 0
let _ = digitalRoot 1
let _ = digitalRoot 9492149
let _ = digitalRoot (-192491535)
let _ = digitalRoot 99999998


let rec listReverse l =
  match l with
    | []	    -> []
    | (h :: t)  -> appendLists(listReverse t, [h])
;;
...
(*XXXXXXXXXX*)
let _ = listReverse []
let _ = listReverse [40]
let _ = listReverse [24; 214]
let _ = listReverse [1;2;3;4;5;6;7;8;9;0]
let _ = listReverse [(0,"zero"); (1, "one"); (2, "two"); (3, "three")]
