...
let _ = pipe2 [(fun x -> x+x); (fun x -> x + 3)] 3

let _ = pipe [(fun x -> x + 3);(fun x-> x + x)] 3
let _ = pipe2 [(fun x -> x + 3);(fun x-> x + x)] 3
...
let _ = sepConcat "!!!!" ["hi"; "bye"]
let _ = sepConcat "~" ["o";"o";"o";"o";"o"]


let stringOfList f l = let nl = List.map f l in
    "[" ^ sepConcat "; " nl ^ "]"
;;
...
let _ = bigAdd [1;0;1] [1;5;1]
let _ = bigAdd [9;8;7] [7;8;9]
let _ = bigAdd [] []
let _ = bigAdd [0] []
let _ = bigAdd [3] []
let _ = bigAdd [0] [0]
...
let rec mulByDigit i l = 
  ...
  in helper (i, 0, List.rev l, [])


let _ = mulByDigit 9 [9;9;9;9]
let _ = mulByDigit 2 [2;9;9;9]
let _ = mulByDigit 7 [1;0;0]
...
let _ = bigMul [1;0;1] [1;0;1]
let _ = bigMul [1;0;0] [1;0;0]
let _ = bigMul [2;7] [5;2]
let _ = bigMul [1;5;1] [1;3;0]
let _ = bigMul [] [0]
let _ = bigMul [0] []
let _ = bigMul [] []
let _ = bigMul [0] [101]
