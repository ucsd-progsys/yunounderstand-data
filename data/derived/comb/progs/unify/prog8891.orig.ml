...
let rec exprToString e = match e with
  ...
  | Average(e1, e2)        -> Printf.sprintf("(" ^ exprToString(e1) ^ "+" ^ exprToString(e2) ^ ")/2") 
  | Times(e1, e2)          -> Printf.sprintf("(" ^ exprToString(e1) ^ "*" ^ exprToString(e2) ^ ")") 
  | Thresh(e1, e2, e3, e4) -> Printf.sprintf("(" ^ exprToString(e1) ^ "<" ^ exprToString(e2) ^ "?" ^ exprToString(e3) ^ ":" ^ exprToString(e4) ^ ")")
