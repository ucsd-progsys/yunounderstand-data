...
let rec digitsOfInt n = 
  ...
  if is10gte n then let x = digitsOfInt(n/10) in
      x @ (n mod 10)::[]
  else n::[] (*XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
...
let rec additivePersistence n = 
  if is10gte then 1 + additivePersistence (sumList(digitsOfInt(n)))
  else 0 ;;
