...
type expr = 
    ...
    | Times    of expr * expr
    | PowerUp  of expr * expr                       (*XXXXXXXXXXXXXX*)
...
let rec exprToString e = match e with
  ...
  | PowerUp(e1,e2)      -> exprToString e1 ^"^"^ exprToString e2                (*XXXXXXXXXXXXXX*)    
  | Square2(e1,e2,e3)   -> "sqrt(" ^ exprToString e1 ^"^2" ^"+"^ exprToString e2  ^"^2" ^"+"^ exprToString e3  ^"^2" ^")/2" (*XXXXXXXXXXXXXX*)
...
let sampleExprPowerUp = Thresh(VarX,VarY,VarX,(PowerUp(Sine(VarX),Cosine(Average(VarX,VarY)))));;

exprToString sampleExprPowerUp;;                              (*XXXXXXXXXXXXXX*)
(*XXXXXXXXXXXXXXXX
XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
*)
...
let buildPowerUp(e1,e2)            = PowerUp(e1,e2)
...
let rec eval (e,x,y) = match e with 
  ...
  | Square2(e1,e2,e3)-> sqrt((eval(e1,x,y))**2. +. (eval(e2,x,y))**2. +. (eval(e3,x,y))**2.)/. 2.     (*XXXXXXXXXXXXXX*)
...
eval (sampleExprPowerUp, -1.,0.5);;                                             (*XXXXXXXXXXXXXX*)
