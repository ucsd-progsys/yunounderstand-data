...
(*XXXXXXXXXX*)
let _ = assoc (-1,"hello",[("hello",85)]);;    
let _ = assoc (-1,"william",[]);;    
let _ = assoc (-1,"william",[("william",85);("william",23);("william",44)]);;    
...
(*XXXXXXXXXX*)
let _ = removeDuplicates [1;1;1;1;1;1;1;1;1];;
let _ = removeDuplicates [];;
let _ = removeDuplicates [1];;
let _ = removeDuplicates [8;6;7;5;3;0;9];;
let _ = removeDuplicates [1;2;3;3;2;1;1;2;3;3;2;1;5;5;5;1;2;6;8;0;2;2;5;2;4;2;5;2;5;2;5];;
...
let f x = let xx = x+x+x in (xx, xx < 100) in
  wwhile (f, 1);;
let f x = let xx = x/5 in (xx, xx > 1) in
  wwhile (f, 100000);;
let f x = let xx = x*x in (xx, xx < 1000) in
  wwhile (f, 2);;
let f x = let xx = x+x+x in (xx, false) in
  wwhile (f, 1);;
...
let _ = fixpoint (sqrt, 12489124.) ;;
let _ = fixpoint (sin, 0.) ;;
...
let mySampleExpr1 = Thresh(VarX,VarY,VarX,VarY);;
let mySampleExpr2 = VarX
let mySampleExpr3 = Average(Sine(VarX), Times(Times(Average(Sine(VarX), VarY), VarX), Thresh(VarX, VarY, VarX, Sine(VarX))))

let _ = exprToString mySampleExpr1
let _ = exprToString mySampleExpr2
let _ = exprToString mySampleExpr3
