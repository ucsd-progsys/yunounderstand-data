...
let rec build (rand, depth) = 
  if depth <= 0 then buildX()
    ...
    | 1 -> 
        buildCosine(build(rand(0,5), depth - 1))
    | 2 -> 
        buildAverage(build(rand(0,5), depth - 2), build(rand(0,5), depth - 2))
    | 3 ->
        buildTimes(build(rand(0,5), depth - 2), build(rand(0,5),depth - 2))
    | 4 ->
        buildThresh(build(rand(0,5), depth - 4), build(rand(0,5), depth - 4), build(rand(0,5), depth - 4), build(rand(0,5), depth -4))
;;
