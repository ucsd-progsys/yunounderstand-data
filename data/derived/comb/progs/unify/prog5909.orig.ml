...
let rec exprToString e = 
  match e with
    ...
    | h::e' -> match h with
      ...
      | Sine e1 -> "sin(pi*"^exprToString e1^")"^exprToString e'
      | Cosine e1 -> "cos(pi*"^exprToString e1^")"^exprToString e'
      | Average (e1,e2) -> "(("^exprToString e1^"+"^exprToString e2^
                           ")/2)"^exprToString e'

      | Times (e1,e2) -> exprToString e1^"*"^exprToString e2^exprToString e'
