...
let padZero l1 l2 = 
  if List.length l1 > List.length l2 then clone 0 ((List.length l1) - (List.length l2)) :: l1 :: l2
  else if  List.length l1 < List.length l2 then clone 0 ((List.length l2) - (List.length l1))
  else []
