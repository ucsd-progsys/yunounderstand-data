...
let rec exprToString e = match e with
  ...
  | Divide3 (d1,d2) -> "((" ^ (exprToString d1) ^ "+" ^ (exprToString d2) ^ ")/3)"
  | MyOp (o1,o2,o3) -> "(" ^ (exprToString o1) ^ ">" ^ (exprToString o2) ^ 
                       "?" ^ (exprToString o3) ^ ":" ^ (exprToString o2) ^ ")"
;;
...
let rec eval (e,x,y) = match e with
  ...
  | Divide3 (d1,d2) -> (eval(d1,x,y) +. eval(d2,x,y))/.(3.0)
  | MyOp (o1,o2,o3) -> if (eval(o1,x,y) > eval(o2,x,y)) then eval(o3,x,y) else eval(o2,x,y)
;;
