...
let rec exprToString e = match e with
  ...
  | Hello1 (e1,e2,e3)      -> "(" ^ (exprToString e1) ^ "<" ^ (exprToString e2) ^ "?" ^
                              (exprToString e3) ^ ":" ^ (exprToString e1) ^ ")" (*XXXXXXXXXXXXXXX*)
  | Thresh (e1,e2,e3,e4)  -> "(" ^ (exprToString e1) ^ "<" ^ (exprToString e2) ^ "?" ^
                             (exprToString e3) ^ ":" ^ (exprToString e4) ^ ")"
  | Hello2 (e1,e2,e3,e4)  -> "(" ^ (exprToString e1) ^ "<" ^ (exprToString e2) ^ "?" ^
                             (exprToString e4) ^ ":" ^ (exprToString e3) ^ ")"
;;


let sampleExpr1 = Thresh(VarX,VarY,VarX,(Times(Sine(VarX),Cosine(Average(VarX,VarY)))));;
let sampleExpr2 = Average(Sine(VarX),Cosine(VarY));;
let sampleExpr3 = Hello1(VarX,VarY,Cosine(VarY));;
let sampleExpr4 = Hello2(VarX,VarY,VarX,Sine(VarY));;
...
let buildHello1(e1,e2,e3)	   = Hello1(e1,e2,e3)
let buildThresh(a,b,a_less,b_less) = Thresh(a,b,a_less,b_less)
let buildHello2(a,b,a_less,b_less) = Hello2(a,b,a_less,b_less)
