...
let buildArcSine(e)	           = ArcSine(e)
let buildArcCosine(e)	           = ArcCosine(e)
...
let g1 () = doRandomGray(8,12,13)
let g2 () = doRandomGray(12,11,12)
let g3 () = doRandomGray(9,9,9)

let c1 () = doRandomColor(11,12,12)
let c2 () = doRandomColor(12,22,21) 
