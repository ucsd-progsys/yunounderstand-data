...
let rec exprToString e = match e with
  ...
  | MyExpr (m,n,o,p)   -> "(" ^ exprToString m ^ "<" ^ exprToString n ^"?sqrt(|" ^
...
let _ = exprToString(MyExpr(VarX,VarY,VarX,VarY))
(*XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX*)
...
let _ = eval (MyExpr(VarX,VarY,VarX,VarY),0.5, 1.0)
let _ = eval (Square(Square(VarY)),1.0,0.5);;
